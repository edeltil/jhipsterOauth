...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jhipsterOauth@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jhipsterOauth API";

        private String description = "jhipsterOauth API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jhipsterOauth";
